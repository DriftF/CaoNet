...
if __name__ == "__main__":
    ...
    training_gt_dir = util.io.join_path(root_dir,'gt_train')
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'cursive_train.tfrecord'), data_path = training_data_dir, gt_path = training_gt_dir)

    test_data_dir = util.io.join_path(root_dir, 'images_test')
    test_gt_dir = util.io.join_path(root_dir,'gt_test')
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, 'cursive_test.tfrecord'), data_path = test_data_dir, gt_path = test_gt_dir)
